...
class MunicipiosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Estados::where('nombre', 'Aguascalientes')->firstOrFail()->municipios()->createMany([
        ...
        Estados::where('nombre', 'Baja California')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Ensenada'],
            ['nombre' => 'Mexicali'],
        ...
        Estados::where('nombre', 'Baja California Sur')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Comondu'],
            ['nombre' => 'La Paz'],
            ['nombre' => 'Loreto'],
            ['nombre' => 'Los Cabos'],
        ...
        Estados::where('nombre', 'Campeche')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Calakmul'],
            ['nombre' => 'Calkini'],
            ['nombre' => 'Campeche'],
            ['nombre' => 'Candelaria'],
        ...
        Estados::where('nombre', 'Coahuila')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Abasolo'],
            ['nombre' => 'Acuna'],
            ['nombre' => 'Allende'],
            ['nombre' => 'Arteaga'],
        ...
        Estados::where('nombre', 'Colima')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Armeria'],
            ['nombre' => 'Colima'],
            ['nombre' => 'Comala'],
            ['nombre' => 'Coquimatlan'],
        ...
        Estados::where('nombre', 'Chiapas')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Acacoyagua'],
            ['nombre' => 'Acala'],
            ['nombre' => 'Acapetahua'],
            ['nombre' => 'Aldama'],
        ...
        Estados::where('nombre', 'Chihuahua')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Ahumada'],
            ['nombre' => 'Aldama'],
            ['nombre' => 'Allende'],
        ...
        Estados::where('nombre', 'Ciudad de México')->firstOrFail()->municipios()->createMany([
        ...
        Estados::where('nombre', 'Durango')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Canatlan'],
            ['nombre' => 'Canelas'],
        ...
        Estados::where('nombre', 'Guanajuato')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Abasolo'],
            ['nombre' => 'Acambaro'],
        ...
        Estados::where('nombre', 'Guerrero')->firstOrFail()->municipios()->createMany([
        ...
        Estados::where('nombre', 'Hidalgo')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Acatlan'],
            ['nombre' => 'Acaxochitlan'],
            ['nombre' => 'Actopan'],
        ...
        Estados::where('nombre', 'Jalisco')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Acatic'],
        ...
        Estados::where('nombre', 'Estado de México')->firstOrFail()->municipios()->createMany([
        ...
        Estados::where('nombre', 'Michoacán')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Acuitzio'],
            ['nombre' => 'Aguililla'],
            ['nombre' => 'Alvaro Obregon'],
            ['nombre' => 'Angamacutiro'],
        ...
        Estados::where('nombre', 'Morelos')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Amacuzac'],
            ['nombre' => 'Atlatlahucan'],
            ['nombre' => 'Axochiapan'],
            ['nombre' => 'Ayala'],
        ...
        Estados::where('nombre', 'Nayarit')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Acaponeta'],
            ['nombre' => 'Ahuacatlan'],
        ...
        Estados::where('nombre', 'Nuevo León')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Abasolo'],
            ['nombre' => 'Agualeguas'],
            ['nombre' => 'Allende'],
            ['nombre' => 'Anahuac'],
        ...
        Estados::where('nombre', 'Oaxaca')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Abejones'],
        ...
        Estados::where('nombre', 'Puebla')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Acajete'],
            ['nombre' => 'Acateno'],
            ['nombre' => 'Acatlan'],
            ['nombre' => 'Acatzingo'],
        ...
        Estados::where('nombre', 'Querétaro')->firstOrFail()->municipios()->createMany([
        ...
        Estados::where('nombre', 'Quintana Roo')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Bacalar'],
            ['nombre' => 'Benito Juarez'],
            ['nombre' => 'Cozumel'],
        ...
        Estados::where('nombre', 'San Luis Potosí')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Ahualulco'],
            ['nombre' => 'Alaquines'],
            ['nombre' => 'Aquismon'],
        ...
        Estados::where('nombre', 'Sinaloa')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Ahome'],
            ['nombre' => 'Angostura'],
            ['nombre' => 'Badiraguato'],
            ['nombre' => 'Choix'],
        ...
        Estados::where('nombre', 'Sonora')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Aconchi'],
            ['nombre' => 'Agua Prieta'],
            ['nombre' => 'Alamos'],
            ['nombre' => 'Altar'],
        ...
        Estados::where('nombre', 'Tabasco')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Balancan'],
            ['nombre' => 'Cardenas'],
            ['nombre' => 'Centla'],
            ['nombre' => 'Centro'],
        ...
        Estados::where('nombre', 'Tamaulipas')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Abasolo'],
            ['nombre' => 'Aldama'],
            ['nombre' => 'Altamira'],
        ...
        Estados::where('nombre', 'Tlaxcala')->firstOrFail()->municipios()->createMany([
        ...
        Estados::where('nombre', 'Veracruz')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Acajete'],
            ['nombre' => 'Acatlan'],
            ['nombre' => 'Acayucan'],
            ['nombre' => 'Actopan'],
        ...
        Estados::where('nombre', 'Yucatan')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Abala'],
            ['nombre' => 'Acanceh'],
            ['nombre' => 'Akil'],
            ['nombre' => 'Baca'],
        ...
        Estados::where('nombre', 'Zacatecas')->firstOrFail()->municipios()->createMany([
            ['nombre' => 'Apozol'],
            ['nombre' => 'Apulco'],
            ['nombre' => 'Atolinga'],
            ['nombre' => 'Benito Juarez'],
